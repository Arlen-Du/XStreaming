...
4. xCloud目前微软调整分辨率策略，部分游戏Xbox Game Pass Ultimate级别会员目前只支持720P/1440P分辨率`,
    ...
    'EasyTier Network': 'EasyTier 虚拟组网',
    'EasyTier Virtual LAN for remote streaming': '内置 EasyTier 虚拟局域网，解决掌机切换强杀与异地串流',
    'EasyTier Connected': 'EasyTier 已连接',
    'EasyTier Connecting': '正在连接 EasyTier...',
    'EasyTier Disconnected': 'EasyTier 未连接',
    'Connect EasyTier': '手动连接 EasyTier',
    'Disconnect EasyTier': '断开 EasyTier 连接',
    'Open EasyTier Pro App': '打开外部 EasyTier Pro',
    'EasyTier Pro': 'EasyTier Pro',
    'EasyTier Pro is not installed': '未检测到已安装的 EasyTier Pro 应用',
    'Connecting': '连接中...',
    'Connection Mode': '连接方式',
    'Paste Token': '从剪贴板粘贴令牌',
    'Peer Nodes': '在线对端节点',
    Custom: '自定义',
    Size: '大小',
    ShowTitle: '展示',
