export default {
  translation: {
    ...
    'EasyTier Network': 'EasyTier Virtual LAN',
    'EasyTier Virtual LAN for remote streaming': 'Integrated EasyTier VPN mesh for handheld remote streaming',
    'EasyTier Connected': 'EasyTier Connected',
    'EasyTier Connecting': 'Connecting to EasyTier...',
    'EasyTier Disconnected': 'EasyTier Disconnected',
    'Connect EasyTier': 'Connect EasyTier',
    'Disconnect EasyTier': 'Disconnect EasyTier',
    'Open EasyTier Pro App': 'Open EasyTier Pro App',
    'EasyTier Pro': 'EasyTier Pro',
    'EasyTier Pro is not installed': 'EasyTier Pro app is not installed',
    'Connecting': 'Connecting...',
    'Connection Mode': 'Connection Mode',
    'Paste Token': 'Paste Token',
    'Peer Nodes': 'Online Peer Nodes',
    Custom: 'Custom',
    Size: 'Size',
    ShowTitle: 'Display',
    Show: 'Show',
